    ...
    <div style={{ backgroundColor: "#0f2318", minHeight: "100vh", fontFamily: "Georgia, 'Times New Roman', serif" }}>
      ...
      <header style={{ borderBottom: "1px solid rgba(201,151,62,0.3)", padding: "20px 0" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 32px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            ...
            <div>
              <p style={{ color: "#c9973e", fontSize: "10px", letterSpacing: "3px", textTransform: "uppercase", margin: 0 }}>Est. Kaki Bukit</p>
              <p style={{ color: "#f5ead4", fontSize: "18px", fontWeight: "bold", margin: 0, letterSpacing: "1px" }}>Nam Yong Industrades</p>
            </div>
          </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "64px", alignItems: "center" }}>
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "28px" }}>
              ...
              <span style={{ color: "#c9973e", fontSize: "11px", letterSpacing: "4px", textTransform: "uppercase" }}>First East Centre · Kaki Bukit</span>
              <div style={{ flex: 1, height: "1px", background: "#c9973e" }} />
            </div>

            <h1 style={{ color: "#f5ead4", fontSize: "clamp(36px, 5vw, 60px)", lineHeight: 1.05, margin: "0 0 8px", fontWeight: "bold" }}>
              Nam Yong
            </h1>
            <h1 style={{ color: "#c9973e", fontSize: "clamp(36px, 5vw, 60px)", lineHeight: 1.05, margin: "0 0 8px", fontWeight: "bold", fontStyle: "italic" }}>
              Industrades
            </h1>
            <h1 style={{ color: "#f5ead4", fontSize: "clamp(18px, 2.5vw, 28px)", lineHeight: 1.05, margin: "0 0 32px", fontWeight: "normal", letterSpacing: "4px", textTransform: "uppercase" }}>
              Hardware Specialists
            </h1>

            <p style={{ color: "#a8b8a0", fontSize: "16px", lineHeight: 1.8, margin: "0 0 36px", maxWidth: "440px" }}>
              Your go-to source for door and window hardware, drawer systems, building materials and industrial supplies at Kaki Bukit. Knowledgeable staff who instantly identify exactly what you need — saving you time and hassle.
            </p>
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4px" }}>
              <img src={photos[0]} alt="Nam Yong Industrades" style={{ width: "100%", aspectRatio: "3/4", objectFit: "cover", display: "block" }} />
              <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                <img src={photos[1]} alt="Nam Yong Industrades" style={{ width: "100%", aspectRatio: "4/3", objectFit: "cover", display: "block" }} />
                <img src={photos[2]} alt="Nam Yong Industrades" style={{ width: "100%", aspectRatio: "4/3", objectFit: "cover", display: "block" }} />
              </div>
            </div>
            <div style={{
              ...
              <p style={{ color: "#c9973e", fontSize: "26px", fontWeight: "bold", margin: 0, lineHeight: 1 }}>3.3</p>
      ...
      <div style={{ background: "#c9973e", padding: "18px 32px", margin: "40px 0 0" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "16px" }}>
          {[
            { icon: "📍", label: "Location", value: "10 Kaki Bukit Rd 2, #01-02" },
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4px" }}>
            ...
            <div style={{ background: "rgba(245,234,212,0.04)", border: "1px solid rgba(201,151,62,0.2)", padding: "56px 48px" }}>
              ...
              <h3 style={{ color: "#f5ead4", fontSize: "32px", margin: "0 0 20px", fontWeight: "bold" }}>Hardware & Industrial</h3>
              <p style={{ color: "#a8b8a0", fontSize: "15px", lineHeight: 1.9, margin: "0 0 32px" }}>
                A comprehensive stock of hardware and industrial supplies — from soft-close drawer runners to HDB window handles, building materials, and everything in between. Walk in with a sample and walk out with the right part.
              </p>
              <ul style={{ color: "#c9973e", padding: "0 0 0 16px", margin: 0 }}>
                {["Door & Window Fittings", "Drawer Systems & Rails", "Locks & Latches", "Fasteners & Fixings", "Industrial Hardware"].map(item => (
            ...
            <div style={{ background: "#c9973e", padding: "56px 48px" }}>
              ...
              <h3 style={{ color: "#0f2318", fontSize: "32px", margin: "0 0 20px", fontWeight: "bold" }}>Wholesale & Bulk Supply</h3>
              <p style={{ color: "rgba(15,35,24,0.8)", fontSize: "15px", lineHeight: 1.9, margin: "0 0 32px" }}>
                Serving contractors, renovators and trade buyers with competitive wholesale pricing. Also available on Lazada — walk-in prices often beat online listings. Fast, knowledgeable service for trade and DIY alike.
              </p>
              <ul style={{ color: "#0f2318", padding: "0 0 0 16px", margin: 0 }}>
                {["Trade & Contractor Pricing", "Building Materials", "Furniture Fittings", "Also on Lazada", "Walk-In Welcome"].map(item => (
                  <li key={item} style={{ fontSize: "14px", marginBottom: "8px", fontFamily: "system-ui, sans-serif" }}>{item}</li>
                ))}
              </ul>
            </div>
          ...
          <div>
            {hours.map((h, i) => (
              <div key={h.day} style={{
                ...
                <span style={{ color: h.open ? "#c9973e" : "rgba(168,184,160,0.4)", fontSize: "14px", fontFamily: "system-ui, sans-serif" }}>{h.time}</span>
              </div>
            ))}
            ...
            <div style={{ marginTop: "40px", padding: "24px", border: "1px solid rgba(201,151,62,0.2)", background: "rgba(201,151,62,0.04)" }}>
              ...
              <p style={{ color: "#f5ead4", fontSize: "16px", margin: "0 0 16px", lineHeight: 1.6 }}>
                10 Kaki Bukit Rd 2, #01-02<br />First East Centre<br />Singapore 417868
              </p>
              <a href="tel:+6563825465" style={{ color: "#c9973e", fontSize: "15px", textDecoration: "none", display: "block" }}>
                📞 +65 6382 5465
              </a>
            </div>
          </div>
      ...
      <section style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 32px 80px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "4px" }}>
          {photos.slice(0, 3).map((url, i) => (
            <img key={i} src={url} alt={`Nam Yong ${i + 1}`} style={{ width: "100%", aspectRatio: "4/3", objectFit: "cover", display: "block", filter: "sepia(15%) brightness(0.9)" }} />
          ))}
        </div>
      </section>
      ...
      <footer style={{ borderTop: "1px solid rgba(201,151,62,0.25)", padding: "40px 32px" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "32px" }}>
            <div>
              <p style={{ color: "#c9973e", fontSize: "11px", letterSpacing: "3px", textTransform: "uppercase", margin: "0 0 10px", fontFamily: "system-ui, sans-serif" }}>Nam Yong Industrades</p>
              <p style={{ color: "#a8b8a0", fontSize: "14px", lineHeight: 1.8, margin: 0, fontFamily: "system-ui, sans-serif" }}>
                Hardware Specialists<br />
                10 Kaki Bukit Rd 2, #01-02<br />
                First East Centre<br />
                Singapore 417868
              </p>
            </div>
            <div>
              ...
              <p style={{ color: "#a8b8a0", fontSize: "14px", lineHeight: 1.8, margin: 0, fontFamily: "system-ui, sans-serif" }}>
                <a href="tel:+6563825465" style={{ color: "#a8b8a0", textDecoration: "none" }}>+65 6382 5465</a>
              </p>
            </div>
            <div>
